/* ═══════════════════════════════════════════════════════════
   RIFAT PORTFOLIO · style.css
   Theme: Dark editorial · Syne + DM Sans · High-contrast
═══════════════════════════════════════════════════════════ */
...
.section {
  padding: 100px 0;
  scroll-margin-top: 88px; /* keeps fixed navbar from covering section tops on direct anchor jumps */
}
...
.hero-noise {
  position: absolute;
  inset: 0;
  background: radial-gradient(ellipse 60% 60% at 20% 50%, rgba(124, 109, 255, 0.08) 0%, transparent 70%),
              radial-gradient(ellipse 40% 40% at 80% 30%, rgba(79, 209, 197, 0.05) 0%, transparent 70%);
}
...
.code-op { color: var(--text-3); margin: 0 4px; }
...
.project-card:hover {
  ...
  box-shadow: 0 16px 48px rgba(124, 109, 255, 0.12);
}
...
/* Project action links (repo / live demo) */
.project-links {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
...
@media (max-width: 768px) {
  ...
  .hero-stat-bar { gap: 20px; padding: 16px 20px; }
...
@media (max-width: 480px) {
  ...
  .step-number { width: 48px; height: 48px; font-size: 0.75rem; }
  .step-connector { left: 23px; top: 56px; }
                   }
